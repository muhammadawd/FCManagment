      ...
      <div class="row">
        ...
        <div class="col-md-9 text-right">
          <router-link :to="{name:'add_program_levels',params: {'program_id':programId}}"
                       v-if="$helper.hasAccessPermission('add-programLevels')"
                ...
                <td>
                  <div class="btn-group direction-inverse">
                    <button class="btn btn-danger" @click="deleteLevel(item)"
                            v-if="$helper.hasAccessPermission('delete-programLevels-by-id')">
                      <i class="ti-trash"></i>
                    </button>
                    <router-link
                      v-if="$helper.hasAccessPermission('update-programLevels-by-id')"
